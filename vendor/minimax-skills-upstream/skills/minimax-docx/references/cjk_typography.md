...
|----------|-------------|-------------|-------|
| **Simplified Chinese** | 宋体 (SimSun) | Noto Sans CJK SC / 微软雅黑 (Microsoft YaHei) | Noto Sans CJK SC is the Fedora/Linux-friendly screen font; SimSun remains common for print |
...
On Fedora/Linux, prefer `Noto Sans CJK SC` when a guide elsewhere suggests `Microsoft YaHei`.
