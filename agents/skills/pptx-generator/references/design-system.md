...
|----------|-------------|--------------|
| **Chinese** | Noto Sans CJK SC on Fedora/Linux | Microsoft YaHei, WenQuanYi Micro Hei, SimHei |
| **English** | Arial | Georgia, Calibri, Cambria, Trebuchet MS |

- For mixed Chinese-English content on Fedora/Linux: use Noto Sans CJK SC for Chinese and the chosen font for English
- For mixed Chinese-English content on Windows: use Microsoft YaHei for Chinese and the chosen font for English
