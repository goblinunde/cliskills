...
A reusable skill for creating and editing visually polished PDFs.  
...
`bash scripts/make.sh fix` helps with Python packages and Playwright, but it does not bootstrap missing Fedora system packages.
